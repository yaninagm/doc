...
Desde el punto de vista del backend se deben preparar los recursos POST para realizar inserciones,ediciones y el borrado de registros, a los cuales el usuario normal no puede tener acceso de ABM. Por eso el modelo funcional también incluye los casos de uso ``Gestionar Tipo de Medición'',``Gestionar Unidad de Medición'' y ``Gestionar Fuente de Medición'' representdos en \textbf{[Figura \ref{2-cu-admin}]}.
