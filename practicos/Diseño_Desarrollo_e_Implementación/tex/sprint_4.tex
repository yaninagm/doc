...
Los casos de uso relevantes para generación de gráficas y validación de datos se encuentran en la \textbf{[Figura \ref{5-cu}]} y \textbf{[Figura \ref{5-cu-admin}]}. A continuación se realizará una breve descripción de cada caso de uso relevante involucrado:
...
Tambien como resultado del sprint obtenemos algunos mensajes de error devueltos directamente por la API, por ejemplo para el caso de validacion de fechas:
