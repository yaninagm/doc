\section{Trabajo práctico integrador Nº2}
...
\subsection{Analizar la aplicación de \textbf{``Retroalimentación a 360''} } % en las áreas asignadas.
...
\subsubsection{Retroalimentación de 360 grados en el área de Auditoría externa}
...
\newpage
    ...
    \subsection{Analizar la aplicación del \textbf{``Coaching Eficaz''} } %en las áreas asignadas.
...
\newpage
    ...
    \subsection{Explicar las \textbf{características de un equipo de trabajo efectivo y un equipo de trabajo equilibrado}} %Con ejemplos dentro de sus áreas, e 5:10
...
\newpage
    ...
    \subsection{Indicar las variables más importantes a tener en cuenta al contratar personal relacionándolo con los puestos y perfiles}%Si tuvieran que \textbf{contratar personal} para las áreas asignadas, 10:20 basado en división de puestos y perfiles. seleccionar un puesto
    ...
    \subsubsection{Para el área de producción}
          \begin{itemize}
        ...
        \subsubsection{Área de Auditoría externa en TI}
            \begin{itemize}
...
\newpage
    \subsection{Detallar las funciones que podría tener un Tablero de Comandos de las áreas correspondientes} %11:37
