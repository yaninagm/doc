	...
	\begin{center} %sidewaystable
		...
		\resizebox{\textwidth}{!}{
			\begin{tabular}{|l|l|l|l|l|}
				...
				Back end& Ivan Terreno &  funcionalidad de editar y ver archivos y análisis & US-\ref{resumenInfo} \& \textbf{US 2} & 6hs\\ \hline         
...
\begin{longtable}{|p{1.5cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|}
